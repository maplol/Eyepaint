...
export const HELP_TIPS: Record<string, HelpTip> = {
  ...
  guides: {
    ...
    page: 'studio',
    title: 'Гиды',
    body: 'Пресеты (3×3, лицо, рост, перспектива) и свои фигуры на отдельном слое «Гид» — крутится тем же transform, что референс. Липкий режим: повторный клик в рельсе выключает.',
  },
  poses: {
    id: 'poses',
    page: 'studio',
